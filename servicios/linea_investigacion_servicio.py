"""
linea_investigacion_servicio.py — Servicio para línea de investigación.
"""
from typing import Any


class ServicioLineaInvestigacion:
    """Servicio para operaciones de negocio de línea de investigación."""
    ...
    async def crear(self, datos: dict) -> dict | None:
        ...
        if exito:
            # Para SERIAL, obtener el último insertado
            return await self.obtener(id_valor=datos.get('id'))
        return None
