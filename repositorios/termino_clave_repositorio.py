"""
termino_clave_repositorio.py — Repositorio para termino_clave.
...
class RepositorioTerminoClavePostgreSQL(BaseRepositorioPostgreSQL):
    """Repositorio concreto para término clave en PostgreSQL."""

    def __init__(self, cadena_conexion: str):
        super().__init__(cadena_conexion)
        self._tabla = "termino_clave"
        self._pk = "termino"
    ...
    async def crear(self, datos: dict, esquema: str = "public") -> bool:
        query = f"""
            INSERT INTO {esquema}.{self._tabla} (termino, termino_ingles)
            VALUES (:termino, :termino_ingles)
        """
