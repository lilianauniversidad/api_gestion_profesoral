"""
linea_investigacion_repositorio.py — Repositorio para linea_investigacion.
PK es 'id' SERIAL (autoincremental).
"""
...
class RepositorioLineaInvestigacionPostgreSQL(BaseRepositorioPostgreSQL):
    """Repositorio concreto para línea de investigación en PostgreSQL."""
    ...
    async def crear(self, datos: dict, esquema: str = "public") -> bool:
        query = f"""
            INSERT INTO {esquema}.{self._tabla} (nombre, descripcion)
